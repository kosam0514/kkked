...
export const EVALUATION_CRITERIA = [
  { name: "절차 준수 점수", score: 10, description: "복장, 신분증 확인부터 사후 정리까지의 기본 절차 이행도" },
...
export const OPERATING_GUIDELINES = [
  "위생 준수: 모든 실습 전후로 철저한 위생 관리를 실시한다.",
  "상호 존중: 실습평가관과 후보생은 상호 존중을 바탕으로 실습에 임한다.",
  "동의와 중단: 모든 실습은 자발적 동의 하에 진행되며, 언제든 중단할 수 있다.",
  "피임 및 안전 규정: 국가가 지정한 안전 및 피임 규정을 엄격히 준수한다.",
  "기록과 평가: 모든 실습 과정은 공정하게 기록되고 평가된다.",
];
